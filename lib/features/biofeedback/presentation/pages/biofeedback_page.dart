            ...
            builder: (context, provider, child) {
              return CustomScrollView(
                ...
                slivers: [
                  ...
                  SliverAppBar(
                    expandedHeight: 120,
                    backgroundColor: const Color.fromARGB(255, 54, 40, 117), // Solid purple color
                    elevation: 8,
                    floating: true,
                    pinned: true,
                      ...
                      background: Container(
                        decoration: const BoxDecoration(
                          gradient: LinearGradient(
                            ...
                            colors: [
                              Color.fromARGB(255, 85, 64, 218),
                              Color.fromARGB(255, 116, 98, 196),
                              Color.fromARGB(255, 89, 78, 139),
                            ],
                          ),
                        ),
                      ),
