...
import 'package:mental_wellness_app/features/mood_detection/presentation/pages/mood_results_page.dart' show MoodResultsPage;
        ...
        children: [
          AnimatedBuilder(
            ...
            builder: (context, child) {
              ...
              if (mounted && !_pulseController.isDisposed) {
    ...
    return Column(
      ...
      children: [
        ...
        AnimatedBuilder(
          ...
          builder: (context, child) {
            return Transform.scale(
              scale: provider.isRecording && mounted && !_pulseController.isDisposed ? _pulseAnimation.value : 1.0,
  ...
  Future<void> _pickAudioFile() async {
    try {
      ...
      if (result != null && result.files.single.path != null) {
        final provider = context.read<AudioDetectionProvider>();
        // --- UPDATED: No text controller needed ---
